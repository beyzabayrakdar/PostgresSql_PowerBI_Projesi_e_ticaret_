# E-Ticaret icaret Satış Analizi Projesi
Bu proje, YETGİM / Techcareer bünyesinde alınan eğitim sürecinin sonunda geliştirilmiş, PostgreSQL tabanlı bir satış ve sipariş yönetimi analiz projesidir. Çalışmanın temel amacı; PostgreSQL üzerinde oluşturulan ilişkisel veritabanından elde edilen müşteri, ürün ve sipariş verilerinin SQL sorguları aracılığıyla analiz edilerek, karar destek süreçlerine katkı sağlayacak anlamlı çıktılar üretilmesidir.
